...
function InfoPanel(props) {
    ...
    return (
        <div className="card specialCard text-center m-2" style={{width: "19em"}}>
            ...
            {props.top ? <div className="text-center"><img src={props.dalleImg} alt={props.dalleAlt} className={topOrBottom} style={{width: "17em", height: "auto", borderRadius: "7px"}} /></div> : null}
            ...
            {!props.top ? <img src={props.dalleImg} alt={props.dalleAlt} className={topOrBottom} style={{width: "17rem", height: "auto", borderRadius: "7px"}} /> : null}
        </div>
    )
}
