                ...
                <div className="text-center">
                    <div className="rocksalt" style={{ display: "inline-block" }}>
                        ...
                        <div className="card mb-3 container specialCard beenie" style={{ width: "75%", display: "inline-block" }}>
                            <p className="m-1">Funk N Spuds is a Minneapolis based musical collective of artists from around the Midwest.</p>
                            <p className="m-1">Formed in early 2020, their jam-rock jazz-pop sounds inspire hope in listeners and positive change in the world.</p>
